...
This project applies **Natural Language Processing (NLP)** techniques to analyze sentiment in tweets. It processes raw text, extracts meaningful features using **TF-IDF**, and classifies sentiment using **machine learning models**.  

## 🚀 Features  
- **Text Preprocessing**: Cleans tweets by removing URLs, mentions, emojis, and punctuation.  
